...
LOCAL_CFLAGS := -DGST_USE_UNSTABLE_API
LOCAL_MODULE := video-receiver
LOCAL_SRC_FILES := video-receiver.c dummy.cpp
LOCAL_SHARED_LIBRARIES := gstreamer_android
LOCAL_LDLIBS := -llog -landroid
...
GSTREAMER_EXTRA_DEPS      := gstreamer-video-1.0 gstreamer-app-1.0 gstreamer-photography-1.0 glib-2.0
